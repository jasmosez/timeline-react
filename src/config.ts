...
export const DEFAULT_BIRTH_DATE = import.meta.env.VITE_DEFAULT_BIRTH_DATE
  ? new Date(import.meta.env.VITE_DEFAULT_BIRTH_DATE)
  : new Date('1982-04-19T02:25:00-05:00') // James bday was 2:25am on 4/19/82, before daylight savings began
